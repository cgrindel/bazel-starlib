...
```python
bazel_dep(name = "cgrindel_bazel_starlib", version = "0.29.2")
```
<!-- END MODULE SNIPPET -->
...
http_archive(
    ...
    sha256 = "ec1f72bc4face8f79ae609d9c7d9acc7ca2032066373b5652314dea6d4390789",
    urls = [
        "https://github.com/cgrindel/bazel-starlib/releases/download/v0.29.2/bazel-starlib.v0.29.2.tar.gz",
    ],
)
