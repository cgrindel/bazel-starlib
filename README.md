...
http_archive(
    ...
    sha256 = "b59cc83c9cd0258b20bde0eca995350ac5ebd494734785df6fa6ad65870fafce",
    urls = [
        "https://github.com/cgrindel/bazel-starlib/releases/download/v0.13.0/bazel-starlib.v0.13.0.tar.gz",
    ],
)
