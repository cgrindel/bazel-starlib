...
def _compile_from_source_buildtools_dependencies():
    maybe(
        ...
        sha256 = "eb7d616e429b29079d60689534a80cfe4d3ca15b10c39a902273d566a4cdd911",
        strip_prefix = "protobuf-4.22.1",
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v4.22.1.tar.gz",
        ],
    )
